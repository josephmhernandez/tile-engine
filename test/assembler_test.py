...
class TestAssembler:
    ...
    def test_pin_in_correct_place(self): 
        ...
        # Define parameters
        context = {
            "bbox": [-77.07801818847658,38.95527071579662,-76.99562072753908, 38.859092581794336],
        ...
        Assembler.add_pins_to_map(context=context, input_path=assembled_cropped_image, output_path='test/assembler_unit_test_attachments/' + output_file)
