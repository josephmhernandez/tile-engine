...
class TransparencyTransformer:
    ...
    def add_background_and_transparency(
        ...
        logging.info("Returning image with alpha layer")
        # logging.info("Saving bg image with alpha layer: " + output_path)
        # bg_img.save(output_path)
        return bg_img

    @staticmethod
    def add_white_background(img, input_path: str, output_path: str):
        ...
        logging.info("[TransparencyTransformer: add_white_background] Returning image")
        return bg
        # logging.info(
